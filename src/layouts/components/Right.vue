...
<template>
    ...
    >
        ...
        <!-- 下半：日志 -->
        <section class="flex-1 min-h-0 overflow-y-auto border-t border-base-300/50 pt-1">
            ...
            <div v-else class="flex flex-col">
                ...
                >
                    ...
                    <span class="text-[11px] leading-snug text-base-content/70 break-words flex-1">{{ log.content }}</span>
